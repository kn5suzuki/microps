...
extern int
sock_bind(int desc, const struct sockaddr *addr);
extern int
sock_listen(int desc, int backlog);
extern int
sock_accept(int desc, const struct sockaddr *addr, int *addrlen);
extern int
sock_connect(int desc, const struct sockaddr *addr);
extern ssize_t
